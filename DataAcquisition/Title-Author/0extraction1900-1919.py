...
try:
    archive = open("1900-1919.txt", "r", encoding="utf-8")
    lines = archive.readlines()
except:
    archive = open("1900-1919.txt", "x", encoding="utf-8")
    lines = []

control = set(lines)
if len(lines) != n:
    archive.close()
    archive = open("1900-1919.txt", "a", encoding="utf-8")
