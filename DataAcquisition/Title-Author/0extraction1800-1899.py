...
try:
    archive = open("1800-1899.txt", "r", encoding="utf-8")
    lines = archive.readlines()
except:
    archive = open("1800-1899.txt", "x", encoding="utf-8")
    lines = []

control = set(lines)
if len(lines) != n:
    archive.close()
    archive = open("1800-1899.txt", "a", encoding="utf-8")
